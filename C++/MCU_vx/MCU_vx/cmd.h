...
namespace mcu
{
	...
	/*!
	* @brief список команд, поддерживаемых методом TMC4361::API::onReceive
	*/
	enum Cmd : uint8_t{
		...
		* будет установлена соответствующая ошибка и аварийно остановлен включенный двигатель. */
		...
		cmdMeasureTemperature 	= 0x36, /**< @brief  Команда считывает прошлые измеренные значения температуры и
